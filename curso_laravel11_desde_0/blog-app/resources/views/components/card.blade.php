...
<div class="px-3 md:lg:xl:px-40   border-t border-b py-20 bg-opacity-10" style="background-image: url('https://www.toptal.com/designers/subtlepatterns/uploads/dot-grid.png') ;">
    <div class="grid grid-cols-1 md:lg:xl:grid-cols-3 group bg-white shadow-xl shadow-neutral-100 border ">
        ...
        <div
            ...
            <p class="text-xl font-medium text-slate-700 mt-3">{{$slot}}</p>
            <p class="mt-2 text-sm text-slate-500">{{$miVariable}}</p>
        </div>
        ...
        <div
            ...
            <p class="text-xl font-medium text-slate-700 mt-3">{{$otraVariableMas}}</p>
    ...
    <div class="w-full bg-indigo-600 shadow-xl shadow-indigo-200 py-10 px-20 flex justify-between items-center">
        <p class="text-white">
          <span class="text-4xl font-medium">Still Confused ?</span>
          <br>
          <span class="text-lg">Book For Free Career Consultation Today ! </span>
        </p>
        <a class=" text-center px-5 py-3 font-medium text-slate-700 shadow-xl hover:bg-white duration-150 bg-yellow-400" href="{{ url('posts/create') }}">CREAR POST</a>
      </div>
